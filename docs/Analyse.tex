...
\hypersetup{unicode=true,
            pdftitle={Cours d'Analyse (1ère Année !!!)},
...
\setlength{\droptitle}{-2em}
  ...
  \title{Cours d'Analyse (1ère Année !!!)}
...
Vous trouverez des vidéos et des tests dans la page moodle développée par Agnes Hamon à l'adresse suivante et plus encore\ldots{} :
